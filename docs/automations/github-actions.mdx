...
Xata provides sample automation workflows to help you automate database operations in your CI/CD pipeline. These workflows help you manage database branches, migrations, and deployments in a safe and automated way.

## Available GitHub Action samples
