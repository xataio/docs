...
- [keys user list](/cli/keys#user-list) - List API keys for the current user
- [keys user create](/cli/keys#user-create) - Create an API key for the current user
- [keys user delete](/cli/keys#user-delete) - Delete an API key for the current user
- [keys organization list](/cli/keys#organization-list) - List API keys for an organization
- [keys organization create](/cli/keys#organization-create) - Create an API key for an organization
- [keys organization delete](/cli/keys#organization-delete) - Delete an API key for an organization
