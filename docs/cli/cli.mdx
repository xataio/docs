...
Note: `xata clone` currently doesn't work with the native Windows installation. We recommend using WSL if you need the clone functionality.. Track progress [here](https://github.com/xataio/pgstream/issues/409).
