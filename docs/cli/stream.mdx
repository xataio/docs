...
description: Commands for managing database streaming operations
---

The `stream` command helps you manage database streaming operations (using logical replication) using `pgstream`.
