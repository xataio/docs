...
Learn how to use Prisma with Xata's PostgreSQL platform. Prisma is a next-generation TypeScript ORM that provides type-safe database access, auto-generated queries, and excellent developer experience.
