...
```
postgresql://xata_replication:your_secure_password@your-rds-endpoint:5432/your_database
```
...
```bash
# Set your source URL
export XATA_CLI_SOURCE_POSTGRES_URL="postgresql://xata_replication:your_secure_password@your-rds-endpoint:5432/your_database"
