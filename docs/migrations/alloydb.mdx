...
```
postgresql://xata_snapshot:your_secure_password@your-alloydb-ip:5432/your_database?sslmode=require
```
...
```bash
# Set your source URL
export XATA_CLI_SOURCE_POSTGRES_URL="postgresql://xata_snapshot:your_secure_password@your-alloydb-ip:5432/your_database?sslmode=require"
