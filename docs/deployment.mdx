...
If you'd like to set up anonymization between your production and development branches, you can accomplish this by starting a staging branch
and configure `xata clone` to copy and anonymize the data between prod and staging.
