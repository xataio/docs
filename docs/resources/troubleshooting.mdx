...
Yes, you can use `xata roll` (powered by [pgroll](https://github.com/xataio/pgroll)) to test schema changes and safely apply them with zero-downtime to production. This allows you to test complex changes in isolation before applying them to production.

## Data Privacy & Security

### How does data anonymization work?
Xata uses [pgstream](https://github.com/xataio/pgstream) to copy and anonymize data on the fly. The system:
