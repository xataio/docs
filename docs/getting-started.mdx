...
![Create branch page](images/getting-started/create-branch.png)
...
![Queries/SQL editor page](images/getting-started/queries.png)
...
![Branch details/schema view](images/getting-started/branch-details.png)
...
![Schema diff page](images/getting-started/schema-diff.png)

## 9. Start from a clean slate
...
## 10. Next steps: choose your workflow

Now that your environment is clean, you're ready to dive deeper:

- **[Developer workflow](/tutorials/developer-workflow):** Learn how to use Xata for staging environments, feature branches, and collaborative development.
...
Pick the path that fits your needs and follow the step-by-step guides to continue your journey!
