...
Create your free Xata account at [console.xata.io](https://console.xata.io). You can sign up with GitHub, Google, or your email address. **Note:** Xata is currently in private beta, please request access and wait for approval before proceeding.
